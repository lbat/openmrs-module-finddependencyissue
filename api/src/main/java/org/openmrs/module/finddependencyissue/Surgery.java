...
//		this.datePlannedFinish = datePlannedFinish;
	...
	public Date getDatePlannedFinishTEST() {
		return datePlannedFinishTEST;
	}

	public void setDatePlannedFinishTEST(Date datePlannedFinishTEST) {
		this.datePlannedFinishTEST = datePlannedFinishTEST;
	}

	public Date getDatePlannedBeginTEST() {
		return datePlannedBeginTEST;
	}

	public void setDatePlannedBeginTEST(Date datePlannedBeginTEST) {
		this.datePlannedBeginTEST = datePlannedBeginTEST;
	}
